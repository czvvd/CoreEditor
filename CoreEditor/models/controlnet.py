...
class ControlNetModel3D(ModelMixin, ConfigMixin):
    ...
    def forward(
        ...
        # controlnet_cond = controlnet_cond.permute(0,2,1,3,4)
        # controlnet_cond = controlnet_cond.reshape(-1,controlnet_cond.size(2),controlnet_cond.size(3),controlnet_cond.size(4))
        # controlnet_cond = F.interpolate(controlnet_cond, size=(sample.size(-2), sample.size(-1)), mode='bilinear', align_corners=False)
        # controlnet_cond = controlnet_cond.reshape(sample.size(0),sample.size(2),controlnet_cond.size(1),controlnet_cond.size(2),controlnet_cond.size(3)).permute(0,2,1,3,4)
