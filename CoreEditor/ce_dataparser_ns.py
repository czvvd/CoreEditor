...
@dataclass
class CoreEditorDataParserConfig(DataParserConfig):
    """Blender dataset parser config"""

    _target: Type = field(default_factory=lambda: CoreEditorDataParser)
...
@dataclass
class CoreEditorDataParser(DataParser):

    config: CoreEditorDataParserConfig

    def __init__(self, config: CoreEditorDataParserConfig):
