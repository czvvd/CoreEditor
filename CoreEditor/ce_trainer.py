...
"""
Code to train CoreEditor model
"""
...
@dataclass
class CoreEditorTrainerConfig(TrainerConfig):
    """Configuration for the CoreEditorTrainer."""
    _target: Type = field(default_factory=lambda: CoreEditorTrainer)
    steps_per_save: int = 500
    """Number of steps between saves."""

class CoreEditorTrainer(Trainer):
    """Trainer for CoreEditor"""
