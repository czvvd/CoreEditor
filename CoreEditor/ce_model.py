...
@dataclass
class CoreEditorModelConfig(SplatfactoModelConfig):
    """Configuration for the CoreEditor."""
    _target: Type = field(default_factory=lambda: CoreEditorModel)
    use_lpips: bool = True
...
class CoreEditorModel(SplatfactoModel):
    """Model for CoreEditor."""

    config: CoreEditorModelConfig
